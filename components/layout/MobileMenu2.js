        ...
        <nav className="menu-box">
              ...
              <ul className="navigation clearfix">
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      <Link href="/index-onepage" onClick={handleMobileMenu}>
                        OnePage Home
                      </Link>
                    </li>
                  </ul> */}
                ...
                <li>
                  <Link href="#news" onClick={handleMobileMenu}>
                    News
                  </Link>
                </li>
                <li>
                  <Link href="#footer" onClick={handleMobileMenu}>
                    Footer
                  </Link>
                </li>
              </ul>
          ...
          <div className="contact-info">
            ...
            <ul>
              ...
              <li>
                <Link href="tel:+910123456789">+91 0123456789</Link>
              </li>
              <li>
