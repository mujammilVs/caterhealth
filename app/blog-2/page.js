                    ...
                    <div className="auto-container">
                        ...
                        <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                            ...
                            <div className="sidebar-widget category-widget">
                                ...
                                <div className="widget-content">
                                    <ul className="category-list clearfix">
                                        ...
                                        <li><Link href="/">Dental Clinic</Link></li>
                                        <li><Link href="/">Neurosurgery</Link></li>
                                        <li><Link href="/">Medical</Link></li>
                                        <li><Link href="/">Pediatrics</Link></li>
                                        <li><Link href="/">Modern Laboratory</Link></li>
                                    </ul>
                                </div>
                            </div>
                            {/* Add more sidebar widgets as needed */}
                            <div className="sidebar-widget category-widget archives-widget">
                                ...
                                <div className="widget-content">
                                    <ul className="category-list clearfix">
                                        <li><Link href="/">December 2021</Link></li>
                                        <li><Link href="/">October 2021</Link></li>
                                        <li><Link href="/">January 2022</Link></li>
                                        <li><Link href="/">October 2022</Link></li>
                                    </ul>
                                </div>
                            </div>
                            {/* Add more sidebar widgets as needed */}
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            ...
                            <div className="news-block-one">
                                ...
                                <figure className="image-box"><Link href="/"><img src="assets/images/news/news-7.jpg" alt="" /></Link></figure>
                                <div className="lower-content">
                                    ...
                                    <h3><Link href="/">How do Inherited Retinal of Diseases Happen?</Link></h3>
                            ...
                            <div className="news-block-one">
                                                <div className="inner-box">
                                                    <figure className="image-box"><Link href="/"><img src="assets/images/news/news-8.jpg" alt="" /></Link></figure>
                                                    <div className="lower-content">
                                                        <ul className="post-info mb_15 clearfix">
                                                            <li><Link href="/">Admin</Link></li>
                                                            <li>11 Jan 2022</li>
                                                        ...
                                                        <h3><Link href="/">Prepare to Speak with Your Eye Specialist.</Link></h3>
                                                        <p>Tincidunt Maur nemi sit Interdum praesento eget morbi lacinia volutpat pellentesque Tincidunt aurna suspit.</p>
                                                        <div className="link">
                                                            <Link href="/"><span>Read More</span></Link>
                                                        </div>
                            ...
                            <div className="news-block-one">
                                                <div className="inner-box">
                                                    <figure className="image-box"><Link href="/"><img src="assets/images/news/news-9.jpg" alt="" /></Link></figure>
                                                    <div className="lower-content">
                                                        <ul className="post-info mb_15 clearfix">
                                                            <li><Link href="/">Admin</Link></li>
                                                            <li>10 Jan 2022</li>
                                                        ...
                                                        <h3><Link href="/">How reliece can help you manage diabetes</Link></h3>
                                                        <p>Tincidunt Maur nemi sit Interdum praesento eget morbi lacinia volutpat pellentesque Tincidunt aurna suspit.</p>
                                                        <div className="link">
                                                            <Link href="/"><span>Read More</span></Link>
                                                        </div>
                            ...
                            <div className="news-block-one">
                                                <div className="inner-box">
                                                    <figure className="image-box"><Link href="/"><img src="assets/images/news/news-10.jpg" alt="" /></Link></figure>
                                                    <div className="lower-content">
                                                        <ul className="post-info mb_15 clearfix">
                                                            <li><Link href="/">Admin</Link></li>
                                                            <li>09 Jan 2022</li>
                                                        ...
                                                        <h3><Link href="/">What Causes Inherited Retinal Diseases?</Link></h3>
                                                        <p>Tincidunt Maur nemi sit Interdum praesento eget morbi lacinia volutpat pellentesque Tincidunt aurna suspit.</p>
                                                        <div className="link">
                                                            <Link href="/"><span>Read More</span></Link>
                                                        </div>
